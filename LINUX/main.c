...
static char_t		*rootWeb = T("/nfsroot/hi3531d/v600/app/webroot");	/* Root web directory */
...
static int mytest(int eid,webs_t wp,int argc,char_t **argv)
{
	char *test = "hello asp";
 ...
 */
	websFormDefine(T("gpio_p24"), on_gp24_set);
	websFormDefine(T("gpio_p25"), on_gp25_set);
	websFormDefine(T("gpio_p26"), on_gp26_set);
	websFormDefine(T("gpio_p27"), on_gp27_set);
