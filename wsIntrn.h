...
extern int CFG_GetDataFromDb(int eid, webs_t wp, int argc, char_t **argv);
extern void CFG_SaveDataToDb(webs_t wp, char_t *path, char_t *query);
extern void CFG_SendData(webs_t wp, char_t *path, char_t *query);
extern int ListTree(int eid, webs_t wp, int argc, char_t **argv);
extern int ListCycle(int eid, webs_t wp, int argc, char_t **argv);
extern int ListOne(int eid, webs_t wp, int argc, char_t **argv);
extern int ListView(int eid, webs_t wp, int argc, char_t **argv);
extern int GetFocus(int eid, webs_t wp, int argc, char_t **argv);


#if 0
#define WEB_TRC_IN 		do {printf("[IN] function %s,line %d\n",__FUNCTION__,__LINE__);}while(0)
#define WEB_TRC_OUT		do {printf("[OUT] function %s,line %d\n",__FUNCTION__,__LINE__);}while(0)
#else
#define WEB_TRC_IN 		do{;}while(0)
#define WEB_TRC_OUT 	do{;}while(0)
#endif
